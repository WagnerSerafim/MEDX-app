...
todos_arquivos = glob.glob(f'{path_file}/bioquimica_exames_resultados.csv')
exames_file = glob.glob(f'{path_file}/bioquimica_exames.csv')

df = pd.read_csv(todos_arquivos[0], engine='python', dtype=str, sep=',', quotechar='"', on_bad_lines='skip')

df_exames = pd.read_csv(exames_file[0], engine='python', dtype=str, sep=',', quotechar='"', on_bad_lines='skip')
