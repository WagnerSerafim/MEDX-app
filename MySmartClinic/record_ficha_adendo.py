...
csv_file = glob.glob(f'{path_file}/ficha_adendo.csv')
...
create_log(log_data, log_folder, "log_inserted_record_ficha_adendo.xlsx")
create_log(not_inserted_data, log_folder, "log_not_inserted_record_ficha_adendo.xlsx")