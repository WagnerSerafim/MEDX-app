...
extension_file = glob.glob(f'{path_file}/atendimento*.csv')

csv.field_size_limit(10**6)
df = pd.read_csv(extension_file[0], sep=';')
df = df.replace('None', '')
df.columns = df.columns.str.strip()
df.to_excel(f'{path_file}/atendimento.xlsx', index=False)
df_excel = pd.read_excel(f'{path_file}/atendimento.xlsx')
