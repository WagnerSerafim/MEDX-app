...
todos_arquivos = glob.glob(f'{path_file}/Dietas.csv')
...
for idx, row in df.iterrows():
    ...
    if name:
        record += f"Nome: {name}<br><br>{content}"
    else:
        record = content
...
create_log(log_data, log_folder, "log_inserted_records_Dietas.xlsx")
create_log(not_inserted_data, log_folder, "log_not_inserted_records_Dietas.xlsx")