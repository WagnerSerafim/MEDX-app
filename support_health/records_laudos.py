...
create_log(log_data, log_folder, "log_inserted_records_Laudos.xlsx")
create_log(not_inserted_data, log_folder, "log_not_inserted_records_Laudos.xlsx")