...
todos_arquivos = glob.glob(f'{path_file}/TB_CONSULTA*.json')
...
create_log(log_data, log_folder, "log_inserted_TB_CONSULTA.xlsx")
create_log(not_inserted_data, log_folder, "log_not_inserted_TB_CONSULTA.xlsx")
