...
json_file = glob.glob(f'{path_file}/pedidoexames.json')
...
create_log(log_data, log_folder, "log_inserted_record_pedidoexames.xlsx")
create_log(not_inserted_data, log_folder, "log_not_inserted_record_pedidoexames.xlsx")