...
cadastro_file = glob.glob(f'{path_file}/clientes_historico.json')
...
for idx, row in df.iterrows():
    ...
    date_str = verify_nan(row['created'])
    if date_str is None:
        date = '1900-01-01'
    else:
        try:
...
create_log(log_data, log_folder, "log_inserted_record_clientes_historico.xlsx")
create_log(not_inserted_data, log_folder, "log_not_inserted_record_clientes_historico.xlsx")
