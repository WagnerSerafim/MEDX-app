...
cadastro_file = glob.glob(f'{path_file}/cliente_documentos.json')
...
create_log(log_data, log_folder, "log_inserted_record_documentos.xlsx")
create_log(not_inserted_data, log_folder, "log_not_inserted_record_documentos.xlsx")
