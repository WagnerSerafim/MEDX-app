...
todos_arquivos = glob.glob(f'{path_file}/IMPRESSO_[0-9]*.csv')
...
create_log(log_data, log_folder, "log_inserted_impresso.xlsx")
create_log(not_inserted_data, log_folder, "log_not_inserted_impresso.xlsx")