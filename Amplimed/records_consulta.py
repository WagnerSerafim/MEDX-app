...
def get_record(json_dict):
    record = ""
    if json_dict["queixa"] != "" and json_dict["queixa"] != "<br":
        record+=f"Queixa: {json_dict["queixa"]}<br>"
    
    if json_dict["listpro"] != "" and json_dict["listpro"] != "<br":
        record+=f"Listpro: {json_dict["listpro"]}<br>"

    if json_dict["plantrat"] != "" and json_dict["plantrat"] != "<br":
        record+=f"Plantrat: {json_dict["plantrat"]}<br>"
    
    if json_dict["conduta"] != "" and json_dict["conduta"] != "<br":
