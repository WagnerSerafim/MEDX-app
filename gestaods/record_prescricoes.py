...
todos_arquivos = glob.glob(f'{path_file}/prescricoes.csv')
...
create_log(log_data, log_folder, "log_inserted_prescricoes.xlsx")
create_log(not_inserted_data, log_folder, "log_not_inserted_prescricoes.xlsx")
