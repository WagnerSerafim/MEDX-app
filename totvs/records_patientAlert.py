...
extension_file = glob.glob(f'{path_file}/patientAlert*.xlsx')
...
for idx, row in df.iterrows():
    ...
    if summary == None:
        ...
        not_inserted_data.append(row_dict)
        continue
    record = f"Alerta do Paciente: {summary}"

    date = '1900-01-01'

    id_patient = verify_nan(row['PacienteId'])
...
create_log(log_data, log_folder, "log_inserted_record_patientAlert.xlsx")
create_log(not_inserted_data, log_folder, "log_not_inserted_record_patientAlert.xlsx")
