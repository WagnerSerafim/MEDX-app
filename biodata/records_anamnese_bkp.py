...
todos_arquivos = glob.glob(f'{path_file}/anamnese_bkp.xlsx')
...
create_log(log_data, log_folder, "log_inserted_record_anamnese_bkp.xlsx")
create_log(not_inserted_data, log_folder, "log_not_inserted_record_anamnese_bkp.xlsx")
