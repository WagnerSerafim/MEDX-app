...
todos_arquivos = glob.glob(f'{path_file}/anexos*.xlsx')
...
for idx, row in df.iterrows():
    ...
    record  = verify_nan(row['NomeAnexo'])
...
create_log(log_data, log_folder, "log_inserted_record_indexes.xlsx")
create_log(not_inserted_data, log_folder, "log_not_inserted_record_indexes.xlsx")