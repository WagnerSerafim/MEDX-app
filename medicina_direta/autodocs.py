...
todos_arquivos = glob.glob(f'{path_file}/modelos_prescricoes*.csv')
...
nome_biblioteca_pai = f"Modelos de Prescrições Migração Medicina Direta {data_hoje}"
...
create_log(log_data, log_folder, "log_inserted_modelos_prescricoes.xlsx")
create_log(not_inserted_data, log_folder, "log_not_inserted_modelos_prescricoes.xlsx")