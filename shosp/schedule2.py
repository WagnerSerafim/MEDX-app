...
for idx, row in df.iterrows():
    ...
    end_str = date_obj + timedelta(minutes=15)
    ...
    service = verify_nan(row['SERVIÇO'])
...
create_log(log_data, log_folder, "log_inserted_relatorio_agendamento.xlsx")
create_log(not_inserted_data, log_folder, "log_not_inserted_relatorio_agendamento.xlsx")
