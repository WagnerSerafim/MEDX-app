...
todos_arquivos = glob.glob(f'{path_file}/importacao-*.csv')
...
create_log(log_data, log_folder, "log_inserted_importacao.xlsx")
create_log(not_inserted_data, log_folder, "log_not_inserted_importacao.xlsx")
